...
import NavbarButton from "../../../ui/Molecules/NavbarButton";
  ...
  return (
    <>
      <nav className="w-full flex flex-col items-center text-amber-50  bg-[#1A1A1E] text-center">
        <div className="w-[95%]">
          <div className="flex gap-4 h-12 justify-between  items-center w-full m-auto border-b-1 border-[#212124]">
